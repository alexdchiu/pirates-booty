...
for workout in workouts:
	...
	workout['intensity'] = random.randint(1,10)
	workout['length_of_workout'] = random.randint(1,6) * 5
	workouts_2.append(workout)

json.dumps(workouts_2)
with open('exercises', 'w', encoding='utf-8') as out:
	json.dump(workouts_2, out, ensure_ascii=False, indent=2)
